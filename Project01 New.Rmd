...
We can also add ggtitle() to give our plot a title and xlab() and ylab() to label the x and y axes (although we don't need to relabel the x-axis in this case). In addition, we have added the function theme_cowplot() that we can add to all of our plots to give them a consistent and clean theme.
...
Backgorund information on neuroblastoma:
