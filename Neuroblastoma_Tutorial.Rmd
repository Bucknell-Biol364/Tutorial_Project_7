...
ggplot(data=NBOnly, #Identify the data frame 
       aes(x=MYCN, fill=Vital_Status)) + #Identify variables and fill=Vital_Status 
  geom_bar() + #Indicating we want the bar graph to show the vital status counts
  ggtitle("The effect of amplification on survival") + #Title
  ylab("Number of Patients") + #Y-axis names 
  theme_cowplot()
```
